  ...
  return (
    <div className="App">
      ...
      <div className='cards'>
        ...
        <Card path="cat8.webp" color="blue" name="Pesto" description="I zoom, I scream, I snuggle—usually in that order."/>
        ...
        <Card path="cat16.avif" color="blue" name="Dusty" description="I emerged from under the couch like a mysterious cryptid and now I rule the living room."/>
      </div>
    </div>
  )
}
